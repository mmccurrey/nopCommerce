    ...
    public partial class SettingController : BaseAdminController
	{
        ...
        public ActionResult Order()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.CustomOrderNumberPrefix_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.CustomOrderNumberPrefix, storeScope);
            }
        ...
        public ActionResult Order(OrderSettingsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.CustomOrderNumberPrefix, model.CustomOrderNumberPrefix_OverrideForStore, storeScope, false);
