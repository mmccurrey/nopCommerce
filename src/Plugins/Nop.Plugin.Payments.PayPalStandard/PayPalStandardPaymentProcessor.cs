...
namespace Nop.Plugin.Payments.PayPalStandard
{
    ...
    public class PayPalStandardPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        public override void Install()
        {
            ...
            this.AddOrUpdatePluginLocaleResource("Plugins.Payments.PayPalStandard.RoundingWarning", "It looks like you have disabled RoundPricesDuringCalculation in the shopping cart settings, keep in mind that this can lead to a discrepancy of the order total amount, as PayPal only rounds to two decimal");
